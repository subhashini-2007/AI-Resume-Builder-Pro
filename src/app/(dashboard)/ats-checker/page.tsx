...
import { UploadCloud, ShieldAlert, CheckCircle, RefreshCw, FileText, Download } from "lucide-react";
...
export default function AtsCheckerPage() {
    ...
    try {
      const res = await fetch("/api/ai", {
        ...
        body: JSON.stringify({
          ...
          payload: {
            ...
            resumeContent:
              resumeContent ||
              "Experienced Senior React Engineer specializing in Next.js, React, and TypeScript.",
          },
        }),
      });
      ...
      if (data.success) {
        ...
        toast({
          ...
          description: `ATS report generated with a score of ${data.data.score}/100.`,
          variant: "success",
        });
      } else {
        throw new Error(data.error || "ATS scan failed");
      }
    } catch (err) {
      const message = err instanceof Error ? err.message : "An error occurred during scanning.";
      toast({
        title: "Scan Failed",
        description: message,
        variant: "destructive",
  ...
  const handleDownloadReport = () => {
    ...
    downloadAnchor.setAttribute(
      "download",
      `ats_report_${jobTitle.toLowerCase().replace(/\s+/g, "_")}.json`
    );
    ...
    toast({
      ...
      description: "The ATS scoring report JSON has been downloaded.",
      variant: "success",
    });
  };
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              ...
              <div
                onClick={() =>
                  toast({
                    title: "File Selector",
                    description:
                      "Please paste your resume text in the text area below for analysis.",
                  })
                }
                className="flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border/80 bg-card/25 p-8 transition-colors hover:border-primary/45"
              >
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    placeholder="Paste resume text or leave empty to auto-extract..."
                    value={resumeContent}
        ...
        <div className="lg:col-span-2">
          <Card className="glassmorphism flex h-full min-h-[350px] flex-col justify-between">
            <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-6">
                      <div className="relative flex items-center justify-center">
                        {/* Semi radial visual representation */}
                        <div className="flex h-24 w-24 items-center justify-center rounded-full border-[10px] border-primary/20 border-t-primary">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                          Your resume has a strong keyword density for the specified role. Address
                          the missing items below to target 90+ points.
                        </p>
                      </div>
                    </div>
