...
// Custom wrapper to support both:
// 1. legacy/custom: <DropdownMenu trigger={...}>...</DropdownMenu>
// 2. standard: <DropdownMenu>...</DropdownMenu>
export function DropdownMenu(
  ...
  if (props && props.trigger) {
    const { trigger, children, align = "end", className } = props;
    return (
